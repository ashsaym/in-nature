...
Bird = function (_React$Component) {_inherits(Bird, _React$Component);
  function Bird(props) {_classCallCheck(this, Bird);var _this = _possibleConstructorReturn(this, (Bird.__proto__ || Object.getPrototypeOf(Bird)).call(this,
    props));_this.
    ...
    clickhandler = function () {
      _this.state.alarmSound.play();
      _this.state.perchTime.pause();
      _this.state.flyTime.
    ...
    };_this.clickhandler = _this.clickhandler.bind(_this);_this.state = { flyTime: new TimelineLite(), alarmSound: new Audio('https://www.dropbox.com/s/q4vsduf0kk7tl3k/alarm.mp3?raw=1'), flutterSound: new Audio('https://www.dropbox.com/s/um3n1tqve70dmhd/flutter.mp3?raw=1'), birdCallSound: new Audio('https://www.dropbox.com/s/shmyhyjgiu2nyvr/call.mp3?raw=1'), perchTime: new TimelineLite({ onComplete: function onComplete() {this.restart();} }) };return _this;}_createClass(Bird, [{ key: 'componentDidMount', value: function componentDidMount() {var _this2 = this;var playFlutter = function playFlutter() {_this2.state.flutterSound.volume = 0.4;_this2.state.flutterSound.play();};var playCall = function playCall() {_this2.state.birdCallSound.play();};this.state.perchTime.to('#bird-head-parts-test', 0.2, { rotation: 30, transformOrigin: '70% 50%', ease: Power4.easeOut }, '3').to('#bird-head-parts-test', 0.2, { rotation: 80, transformOrigin: '60% 50%', ease: Power4.easeOut }, '+=1').fromTo('#flutter', 0.1, { autoAlpha: 1 }, { autoAlpha: 0, repeat: 6 }, '0').to('#bird-head-parts-test', 0, { transformOrigin: '70% 50%', css: { scaleY: -1, rotation: 90 }, ease: Power4.easeOut }, '+=1').call(playCall, ['Call SOUND'], this, '+=0').to('#bird-head-parts-test', 1, { transformOrigin: '70% 50%', css: { rotation: 160 }, ease: Power4.easeOut }, '+=1').call(playFlutter, ['FLUTTER SOUND MID '], this, '-=1').fromTo('#flutter', 0.1, { autoAlpha: 1, ease: Power4.Linear }, { autoAlpha: 0, ease: Power4.Linear, repeat: 5 }, '-=1').to('#tail-torso', 0.2, { css: { rotation: 10, scaleX: -1, transformOrigin: '50% 50%' }, ease: Power4.easeOut }, '-=1').to('#bird-head-parts-test', 0.2, { transformOrigin: '70% 50%', css: { scaleY: 1, rotation: 40 }, ease: Power4.easeOut }, '-=1').to('#bird-head-parts-test', 0.2, { rotation: 0, transformOrigin: '70% 50%', ease: Power4.easeOut }, '+=1').to('#bird-head-parts-test', 0.5, { rotation: 40, transformOrigin: '70% 50%', ease: Power4.easeOut }, '+=2').call(playFlutter, ['FLUTTER SOUND A @0 '], this, '0');} }, { key: 'render', value: function render()
...
Duck = function (_React$Component2) {_inherits(Duck, _React$Component2);
  function Duck(props) {_classCallCheck(this, Duck);var _this3 = _possibleConstructorReturn(this, (Duck.__proto__ || Object.getPrototypeOf(Duck)).call(this,
    props));
    _this3.state = {
      timeline: new TimelineLite() };return _this3;

  }_createClass(Duck, [{ key: 'componentDidMount', value: function componentDidMount()

    {
      this.state.timeline.fromTo('#duck-svg', 200, { x: 400, ease: Circ.easeOut }, { x: -700 });
      var rippleTime = new TimelineLite({ repeat: -1 });
      rippleTime.
...
Pond = function (_React$Component3) {_inherits(Pond, _React$Component3);
  function Pond(props) {_classCallCheck(this, Pond);var _this4 = _possibleConstructorReturn(this, (Pond.__proto__ || Object.getPrototypeOf(Pond)).call(this,
    props));
    _this4.state = {
  ...
  }_createClass(Pond, [{ key: 'componentDidMount', value: function componentDidMount()
    {
      this.state.waveTime.
      fromTo(
      "#wave-1",
...
Scene = function (_React$Component4) {_inherits(Scene, _React$Component4);
  function Scene(props) {_classCallCheck(this, Scene);var _this5 = _possibleConstructorReturn(this, (Scene.__proto__ || Object.getPrototypeOf(Scene)).call(this,
    props));
    _this5.state = {
      sceneSound: new Audio(
      "https://www.dropbox.com/s/yiuttz27526uk1q/atmosphere.mp3?raw=1") };return _this5;


  }_createClass(Scene, [{ key: 'componentDidMount', value: function componentDidMount()
    {
